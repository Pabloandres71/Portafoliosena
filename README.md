...
<body>
  ...
  <header class="bg-dark text-white text-center py-5">
    <div class="container">
      <img id="logo" src="images/logo_pb.png" alt="">
  ...
  <section id="about" class="container py-5">
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <img src="images/positivo_pb.png" alt="Pablo Andres Betancur" class="img-fluid rounded shadow">
      </div>
      <div class="col-md-6">
  ...
  <div id="proyectoCarrusel" class="carousel slide mt-4" data-bs-ride="carousel" data-bs-interval="3000">
    <div class="carousel-indicators">
      ...
      <button type="button" data-bs-target="#proyectoCarrusel" data-bs-slide-to="2"></button>
    </div>

    <div class="carousel-inner rounded shadow">
      <div class="carousel-item active">
        <img src="images/img1.png" class="d-block w-100" alt="Proyecto 1">
        <div class="carousel-caption d-none d-md-block">
          <h5>Identidad visual para marca X</h5>
        </div>
      </div>
      <div class="carousel-item">
        <img src="images/img2.jpg" class="d-block w-100" alt="Proyecto 2">
        <div class="carousel-caption d-none d-md-block">
          <h5>Animación promocional para evento Y</h5>
        </div>
      </div>
      <div class="carousel-item">
        <img src="images/img3.png" class="d-block w-100" alt="Proyecto 3">
        <div class="carousel-caption d-none d-md-block">
          <h5>Animación promocional para evento Z</h5>
        </div>
      </div>
    </div>
  ...
  <section id="experience" class="container py-5">
    ...
    <div class="row g-4">
      ...
      <!-- Crystal -->
      <div class="col-md-4">
        <img src="images/crystal.jpg" class="img-fluid rounded shadow-sm cursor-pointer" alt="Crystal"
          data-bs-toggle="modal" data-bs-target="#modalCrystal">
      </div>

      <!-- Fortis -->
      <div class="col-md-4">
        <img src="images/fortis.png" class="img-fluid rounded shadow-sm cursor-pointer" alt="Fortis"
          data-bs-toggle="modal" data-bs-target="#modalFortis">
      </div>

      <!-- Condutransito -->
      <div class="col-md-4">
        <img src="images/positivo_pb.png" class="img-fluid rounded shadow-sm cursor-pointer" alt="Maluma"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered animate__animated animate__fadeIn">
      <div class="modal-content shadow-lg border-0">
        ...
        <div class="modal-body">
          <img src="images/captura1pb.png" class="img-fluid rounded mb-3" alt=""><img src="images/captura1bby.png"
            class="img-fluid rounded mb-3" alt=""><img src="images/captura1gef.png" class="img-fluid rounded mb-3"
            alt="">
  ...
  <div class="modal fade" id="modalFortis" tabindex="-1" aria-labelledby="modalFortisLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered animate__animated animate__fadeIn">
      <div class="modal-content shadow-lg border-0">
        ...
        <div class="modal-body">
          <img src="images/captura1.png" class="img-fluid rounded mb-3" alt=""><img src="images/captura4.png"
            class="img-fluid rounded mb-3" alt=""><img src="images/captura3.png" class="img-fluid rounded mb-3"
            alt="">
          <p><strong>Año:</strong> 2024</p>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="images/maluma.png" class="card-img-top" alt="Proyecto Web">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="images/crystal.jpg" class="card-img-top" alt="Proyecto Web">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="images/fortis.png" class="card-img-top" alt="Proyecto Web">
          <div class="card-body">
